        ...
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center gap-12 relative z-10">
          ...
          >
            ...
            <motion.p variants={itemVariants} className="text-lg text-slate-300 leading-relaxed">
              Founder of <a href="https://space-gen.github.io" className="btn-secondary inline-block px-2 py-1 rounded text-solar-400 hover:bg-solar-500/10 transition-colors focus:outline-none focus:ring">SpaceGen</a>,

    ...
    return (
      <NavLink
        ...
        className="flex items-center gap-2 px-2 py-1 rounded-lg border border-white/10 hover:bg-white/5 transition-colors"
            aria-label="GitHub connected — open Account page"
        title={`GitHub: ${user.login}`}
      >
        <img
          src={user.avatar_url}
          alt={user.login}
          className="w-6 h-6 sm:w-7 sm:h-7 rounded-full ring-1 ring-solar-500/40"
        />
      </NavLink>
    );
  }
    ...
    <>
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16 lg:h-20 flex-nowrap">
            <NavLink
              to="/"
              className="flex items-center gap-0 flex-shrink-0 group select-none"
            ...
            >
              ...
              <div className="flex flex-col">
                ...
                <span className="inline-flex text-[9px] sm:text-[10px] uppercase tracking-widest text-slate-500 font-semibold -mt-0.5 group-hover:text-solar-400 transition-colors items-center gap-1">
                  <span className="sr-only sm:not-sr-only">by</span>
                  <img src={`${base}spacegen.svg`} alt="SpaceGen" className="w-3 h-3 sm:w-4 sm:h-4 inline-block" />
                  <span>SpaceGen</span>
                </span>
              </div>
            </NavLink>
            ...
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              {ghUser && (
                <div className="flex items-center gap-2">
                  <PointsDisplay points={points} compact streak={streak} />
                </div>
              )}
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="ml-1 btn-solar px-3 py-2 rounded-xl text-sm hidden sm:inline-flex"
                aria-label="Fund SpaceGen"
                title="Support SpaceGen"
              >
                Fund
              </a>
            ...
            <div className="max-w-7xl mx-auto px-4 py-4 flex flex-col gap-2">
              ...
              <motion.div variants={itemVariants} className="mt-2">
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="block px-4 py-3 rounded-xl text-sm font-medium text-slate-200 bg-solar-500/20 text-center"
                >
                  Fund
                </a>
              </motion.div>
